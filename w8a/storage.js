...
//when setting an item, it overrides the previous setItem from before. (1, 2, 3 would be shown instead of Sevein)

// localStorage.setItem(LOCAL_STORAGE_KEY, "Sevein");
// localStorage.setItem(LOCAL_STORAGE_KEY, [1, 2, 3]);

//JSON will be used in a variety of aspects (Javascript Object Notation)
...
export const clearAllEntries = function () {
    localStorage.removeItem(LOCAL_STORAGE_KEY);
    console.log('All entries clear form localStorage');
}